            ...
            "conditions": [
                [
                    ...
                    },
                    {
                        ...
                        "ccflags": ["-fno-builtin-memcmp", "-fPIC"],
                        "cflags": ["-std=c++0x"],
                        "cflags!": ["-fno-tree-vrp"],
                    },
                ],
                ...
                [
                    "OS == 'freebsd'",
                    {
                        "defines": ["OS_FREEBSD=1", "_REENTRANT=1"],
                        "libraries": ["-lpthread"],
                        "ccflags": ["-pthread"],
                ...
                [
                    "OS == 'openbsd'",
                    {
                        "defines": ["OS_OPENBSD=1", "_REENTRANT=1"],
                        "libraries": ["-lpthread"],
                        "ccflags": ["-pthread"],
                        "cflags": ["-Wno-sign-compare"],
                    },
                ...
                [
                    "OS == 'solaris'",
                    {
                        "defines": ["OS_SOLARIS=1", "_REENTRANT=1"],
                ...
                [
                    "OS == 'android'",
                    {
                        "defines": ["OS_ANDROID=1", "_REENTRANT=1"],
                        "libraries": ["-lpthread"],
                        "ccflags": ["-pthread", "-fno-builtin-memcmp"],
                        "cflags": ["-fPIC"],
                        "cflags!": [
                            "-fPIE",
                            "-mfloat-abi=hard",
                ...
                ["target_arch == 'arm'", {"cflags": ["-mfloat-abi=hard"]}],
            ],
            "sources": [
